...
// inserts iProduct record into ostream object
	std::ostream& operator<<(std::ostream& os, const iProduct& ipr);
// extracts iProduct record from istream object
	std::istream& operator>>(std::istream& is, iProduct& ipr);
// adds total cost of iProduct to double received and return updated value
	double operator+=(double& add, const iProduct& ipr);
